...
static int winfo_get_terminal_dimensions(winfo_t* window_info)
{
    #ifdef __linux__
        struct winsize ws;
        if ( (ioctl(0, TIOCGWINSZ, &ws) ) != 0)
        {
            fprintf(stderr, "Fuck you! Couldn't determine terminal size!\n");
        ...
        window_info->ccols = (int)(csbi.srWindow.Right - csbi.srWindow.Left + 1) * 0.5;
        window_info->crows = (int)(csbi.srWindow.Bottom - csbi.srWindow.Top + 1) * 0.5;
    #endif
